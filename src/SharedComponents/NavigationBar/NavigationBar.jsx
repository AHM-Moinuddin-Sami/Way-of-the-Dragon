...
const NavigationBar = () => {
    ...
    return (
        <div className={`navbar border-2 border-t-0 border-l-0 border-r-0 bg-slate-200 bg-opacity-5 ${theme === "dark" ? "border-b-red-600" : "border-b-black"}`}>
            <div className="navbar-start  menu-tile">
                ...
                <Link className="md:text-3xl text-xl font-bold flex items-center">
                    <img ref={imageRef} className="h-14 w-14 md:h-16 md:w-16" src="https://i.ibb.co/MVgkP8Z/400129-removebg-preview.png" alt="" /> <span className="site-title hidden md:flex text-primary">Way of the Dragon</span>
                </Link>
            </div>
            <div className="navbar-center hidden lg:flex  menu-tile">
                <ul className="menu menu-title text-5xl menu-horizontal px-1 items-center">
                    <li><Link to={"/"}>Home</Link></li>
                    <li><Link to={"/classes"}>All Classes</Link></li>
                    <li><Link to={"/instructors"}>All Instructors</Link></li>
