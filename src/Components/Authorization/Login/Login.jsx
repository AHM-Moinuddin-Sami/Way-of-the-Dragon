...
const Login = () => {
    ...
    return (
        <div className="hero min-h-screen bg-base-200 " style={{ backgroundImage: `url("https://pngtree.com/freebackground/chinese-style-martial-arts-recruitment-advertising-background_1066757.html")`, backgroundSize:'cover' }}>
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="min-w-[50vh] section-title text-center lg:text-left text-base-200">
